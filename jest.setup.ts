...
process.env["CRON_SECRET"] ??= "cron-secret-cron-secret-cron-secret-cr";
process.env["PAGEVIEW_HASH_SALT"] ??= "pageview-salt-pageview-salt-pageview-s";
process.env["REDIRECT_LOOKUP_SECRET"] ??= "redirect-secret-redirect-secret-red";
